...
nos_PS$NAME[nos_PS$NAME == "NODE_33200_length_1820_cov_185.679450_g23515_i0.p1"] <- "PsbA1"
nos_PS$NAME[nos_PS$NAME == "NODE_81960_length_870_cov_125019.715182_g66510_i0.p1"] <- "PsbA2"
...
nos_PS_plot<-ggplot(nos_PS_tg.summary, aes(x = Gene, y = len)) +
  ...
  scale_x_discrete(limits = c("PsaA","PsbA2","CpcA","CpeA","","RbcL","CccM"))+
  xlab("") +
...
ple_PS$NAME[ple_PS$NAME == "NODE_19751_length_2701_cov_4954.788813_g13333_i0.p1"] <- "PsaA1"
ple_PS$NAME[ple_PS$NAME == "NODE_1511_length_10440_cov_4349.966818_g1058_i0.p1"] <- "PsaA2"
ple_PS$NAME[ple_PS$NAME == "NODE_1375_length_10838_cov_1438.095866_g969_i0.p1"] <- "PsaA3"
ple_PS$NAME[ple_PS$NAME == "NODE_4757_length_6333_cov_56.899042_g3181_i0.p1"] <- "PsaA4"
ple_PS$NAME[ple_PS$NAME == "NODE_70_length_27121_cov_248.993382_g53_i0.p6"] <- "PsbA1"
ple_PS$NAME[ple_PS$NAME == "NODE_23791_length_2350_cov_26283.451910_g802_i3.p1"] <- "PsbA2"
ple_PS$NAME[ple_PS$NAME == "NODE_174_length_22195_cov_217.718380_g132_i0.p8"] <- "PsbA3"
ple_PS$NAME[ple_PS$NAME == "NODE_41_length_30295_cov_377.508338_g29_i0.p20"] <- "CpcA1"
ple_PS$NAME[ple_PS$NAME == "NODE_2632_length_8241_cov_291.273384_g1815_i0.p7"] <- "CpcA2"
ple_PS$NAME[ple_PS$NAME == "NODE_14124_length_3420_cov_96.905886_g9397_i0.p4"] <- "CpeA1"
ple_PS$NAME[ple_PS$NAME == "NODE_47921_length_1351_cov_28.586072_g35681_i0.p2"] <- "CpeA2"
ple_PS$NAME[ple_PS$NAME == "NODE_190_length_21684_cov_465.159410_g142_i0.p5"] <- "RbcL"
ple_PS$NAME[ple_PS$NAME == "NODE_7497_length_5038_cov_463.560524_g4982_i0.p1"] <- "CcmM1"
ple_PS$NAME[ple_PS$NAME == "NODE_9293_length_4464_cov_51.033478_g6166_i0.p1"] <- "CcmM2"
ple_PS$NAME[ple_PS$NAME == "NODE_423_length_16370_cov_3813.623182_g313_i0.p1"] <- "CcmM3"
ple_PS$NAME[ple_PS$NAME == "NODE_7638_length_4993_cov_64.689228_g5068_i0.p1"] <- "CcmM4"
ple_PS$NAME[ple_PS$NAME == "NODE_6273_length_5527_cov_89.561239_g4156_i0.p1"] <- "CcmM5"
ple_PS$NAME[ple_PS$NAME == "NODE_6744_length_5315_cov_351.019649_g464_i2.p1"] <- "CcmM6"
ple_PS$NAME[ple_PS$NAME == "NODE_6967_length_5229_cov_37.146431_g4191_i1.p1"] <- "CcmM7"
ple_PS$NAME[ple_PS$NAME == "NODE_190_length_21684_cov_465.159410_g142_i0.p2"] <- "CcmM8"
...
ple_PS_plot<-ggplot(ple_PS_tg.summary, aes(x = Gene, y = len)) +
  ...
  theme(strip.background = element_blank(),
        ...
        axis.ticks.x = element_blank(),  
        aspect.ratio = 0.5) +
  #  scale_x_discrete(limits = c("PsaA1","PsaA2","PsaA3","PsaA4","PsbA1","PsbA2","PsbA3","CpcA1","CpcA2","CpeA1","CpeA2","RbcL","CcmM1","CcmM2","CcmM3","CcmM4","CcmM5","CcmM6","CcmM7","CcmM8"))+
  scale_x_discrete(limits = c("PsaA1","PsbA2","CpcA1","CpeA1","","RbcL","CcmM3"))+
  xlab("") +
...
nos_EPS_plot<-ggplot(nos_EPS_tg.summary, aes(x = Gene, y = len)) +
  annotate("rect", xmin = 0.5, xmax = 4.5, ymin = 0, ymax = Inf,
           alpha = .1,fill = "black")+
...
nos_ST_plot<-ggplot(nos_ST_tg.summary, aes(x = Gene, y = len)) +
  # annotate("rect", xmin = 0.5, xmax = 4.5, ymin = 0, ymax = Inf,
  #           alpha = .1,fill = "black")+
  geom_col(aes(fill = condition), position = position_dodge(0.8), width = 0.7)+
  geom_errorbar(
  ...
  scale_x_discrete(limits = c("GlsCD1","GlsCD2","GlsCD3","GlsCD4","GlsP","GlsR1","GlsR2","GlsQ1","GlsQ2"))+
  xlab("") +
  ylab("Nostocales transcripts per million (TPM)")
...
ple_ST_plot<-ggplot(ple_ST_tg.summary, aes(x = Gene, y = len)) +
  ...
  scale_x_discrete(limits = c("GlsCD1","GlsCD2","GlsCD3","GlsP1","GlsP2","GlsP3","GlsR","GlsQ"))+
  xlab("") +
  ylab("Pleurocapsales transcripts per million (TPM)")
...
asc_GH<-asc_diff_ex_READS_df %>% filter((NAME == "NODE_127486_length_619_cov_4086.091575_g110534_i0.p1"|
                                           ...
                                           NAME == "NODE_7801_length_4932_cov_93.028607_g5171_i0.p5_1"|
...
asc_GH$NAME[asc_GH$NAME == "NODE_7801_length_4932_cov_93.028607_g5171_i0.p5_1"] <- "GH20.2"
...
asc_GH_plot<-ggplot(asc_GH_tg.summary, aes(x = Gene, y = len)) +
  # annotate("rect", xmin = 0.5, xmax = 4.5, ymin = 0, ymax = Inf,
  #           alpha = .1,fill = "black")+
  geom_col(aes(fill = condition1), position = position_dodge(0.8), width = 0.7)+
  geom_errorbar(
    aes(ymin = len-sd, ymax = len+sd, group = condition1),
    width = 0.2, position = position_dodge(0.8))+
  #ylim(0,100) +
  scale_fill_manual(values = c("#37ABC8", "#005544")) +
  ...
  theme(strip.background = element_blank(),
        ...
        axis.ticks.x = element_blank(),  
        aspect.ratio = 0.25) +
  scale_x_discrete(limits = c("GH1","","GH3.1","GH3.2","GH3.3","","GH5.1","GH5.2","","GH7","","GH10","","GH11","","GH12","","GH16.1","GH16.2","GH16.3","GH16.4","","GH17.1","GH17.2","GH17.3","GH17.4","","GH18.1","GH18.2","","GH20.1","GH20.2","","GH28","","GH30","","GH31.1","GH31.2","","GH32","","GH37","","GH38","","GH43","","GH45","","GH47.1","GH47.2","GH47.3","GH47.4","GH47.5","","GH51","","GH62","","GH63","","GH79","","GH81"))+
  xlab("") +
  ylab("Ascomycota transcripts per million (TPM)")